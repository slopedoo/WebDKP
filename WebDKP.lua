...
BossLocation = Set {"The Molten Core", "Blackwing Lair", "Onyxia's Lair", "Ahn'Qiraj", "Temple of Ahn'Qiraj", "Naxxramas", "The Arachnid Quarter", "The Plague Quarter", "The Military Quarter", "The Construct Quarter", "Frostwyrm Lair"}
...
function WebDKP_Bosskill()
	StaticPopupDialogs["HANDOUT_BOSSDKP_PROMPT"] = {
		text = "Do you want to award 2 dkp for boss?",
	  	button1 = "Yes",
	  	button2 = "No",
		--OnShow = function ()
		...
		--end,
	  	OnAccept = function()
	      	...
	      	--DEFAULT_CHAT_FRAME:AddMessage("test, ADDING MANUALLY DKP 2 all raid! yey"..text_editbox)
	  	end,
	  	timeout = 0,
	  	--hasEditBox = true,
	  	whileDead = true,
...
function WebDKP_AddHourly()
	StaticPopupDialogs["HANDOUT_HOURLY_PROMPT"] = {
		text = "Do you want to award 2 dkp (hourly dkp)?",
	  	button1 = "Yes",
	  	button2 = "No",
	  	OnAccept = function()
	  		--local text_editbox = getglobal(this:GetParent():GetName().."EditBox"):GetText();
